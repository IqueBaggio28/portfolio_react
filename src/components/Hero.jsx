...
const Hero = () => {
  return (
    <section className="container_sec">
      ...
      <h3 className="text-[var(--clr-slate600)] text-lg font-bold ">
        Hi, my name is Henrique
      </h3>
      <h1 className="text-4xl font-black text-center text-[var(--clr-slate400)] text-wrap px-20">
        SOFTWARE ENGINEER
      </h1>
      <p className="text-center text-[var(--clr-slate600)] font-medium">
