...
const Experience = ({sectionHeader}) => {
    ...
    const companies = [
        {name: 'Rentvine', title: 'FRONT-END DEVELOPER (I)', companyImg: 'images/rv-icon.png', description: [
            ...
            , date: 'Nov 2024 - Present', stacks: [{icon: faJsSquare, color: 'yellow'}, {icon: faHtml5, color: '#e34c26'}, {icon: faCss, color: '#264de4'}, {icon: faPhp, color: '#8892be' }]},
        {name: 'Ottimizza Ltda.', title: 'SFTW ENGINEERING INTERN ', companyImg: 'images/ottimizza-icon.png', description: [
            ...
            , date: 'June 2023 - Aug 2023', stacks: [{icon: faJava, color: '#f89820'}, {icon: faDatabase, color: '#3776ab'}, {icon: faAws, color: '#ff9900'}]},
        {name: 'Dendritic Hub', title: 'RESEARCH ASSISTANT', companyImg: 'images/fgcu-icon.png', description: [
            ...
            , date: 'Nov 2023 - Nov 2024', stacks: [{icon: faPython, color: '#3776ab'}]},
        {name: 'U.A. Whitaker College of Engineering', title: 'SFTW ENGINEERING TUTOR', companyImg: 'images/fgcu-icon.png', description: [
            ...
            , date: 'Aug 2023 - Nov 2024', stacks: [{icon: faPython, color: '#3776ab'}, {icon: faJava, color: '#f89820'}, {svg: 'images/cpp-icon.svg' , color: '#3776ab'}, {svg: 'images/c-icon.svg' , color: '#3776ab'}]},
        {name: 'U.A. Whitaker College of Engineering', title: 'TEACHING ASSISTANT ', companyImg: 'images/fgcu-icon.png', description: [
