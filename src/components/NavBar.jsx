...
const NavBar = ({ navBarOpen, setNavBarOpen }) => {
  ...
  return (
    navBarOpen && (
      <div className="h-screen w-full z-50 absolute top-0 left-0 bg-[var(--clr-dark)] overflow-x-hidden sm:hidden">
        ...
        <div className="flex flex-col h-full items-center justify-center pb-3">
          <ul className="flex flex-col gap-4 items-center">
            ...
            <li>
              <button className="btn w-fit mt-4 border-t-white">Contact</button>
            </li>
          </ul>
        </div>
      </div>
